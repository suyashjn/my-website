...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 px-4 pt-4">
      <div className="glass-panel mx-auto max-w-4xl rounded-3xl sm:rounded-full">
        <div className="flex items-center justify-between px-5 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="relative flex h-7 w-7 shrink-0 items-center justify-center sm:hidden"
            >
              <span
              ...
              />
              <span
                className={`absolute h-px w-4 bg-ink transition-opacity duration-300 ${
        ...
        >
          <nav id="mobile-nav" aria-label="Mobile section navigation" className="min-h-0 overflow-hidden">
                ...
                return (
                  <li key={item.id}>
                    <a
                      ...
                      aria-current={isActive ? "true" : undefined}
                      className={`group block rounded-lg px-3 py-2 font-mono text-xs transition-colors ${
                        isActive ? "text-ink" : "text-dim hover:text-ink"
                      }`}
                    >
